...
export class profileUserComponent implements OnInit {
    ...
    ngOnInit(): void {
        ...
        this.first_name = this.dataUser.dataset.first_name
        this.last_name = this.dataUser.dataset.last_name
        this.nationality = this.dataUser.dataset.nationality
        this.address = this.dataUser.dataset.address
        this.tel = this.dataUser.dataset.tel
        this.gender = this.dataUser.dataset.gender
        this.dob =  this.dataUser.dataset.birthday
